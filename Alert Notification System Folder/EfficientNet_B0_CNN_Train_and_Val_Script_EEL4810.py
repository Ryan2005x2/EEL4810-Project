# This is a program that trains an EfficientNet B0 CNN model on the USTC Smoke Dataset to predict wildfire from satellite images.
# Written By Ryan Andersen, 3/6/2025
